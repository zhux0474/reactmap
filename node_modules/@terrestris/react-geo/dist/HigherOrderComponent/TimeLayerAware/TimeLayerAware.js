      ...
      _defineProperty(_assertThisInitialized(_this), "timeChanged", function (newValues) {
        layers.forEach(function (config) {
          if (config.isWmsTime) {
            ...
            var parms = (_config$layer$getSour = config.layer.getSource()) === null || _config$layer$getSour === void 0 ? void 0 : _config$layer$getSour.getParams();
            ...
            (_config$layer$getSour2 = config.layer.getSource()) === null || _config$layer$getSour2 === void 0 ? void 0 : _config$layer$getSour2.updateParams(parms);
          }
